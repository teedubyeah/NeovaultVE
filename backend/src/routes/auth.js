...
router.post('/login', async (req, res) => {
  ...
  try {
    ...
    // Always run a hash verification to prevent username-enumeration via timing
...
router.post('/change-password', requireAuthWithKey, async (req, res) => {
  ...
  const oldKey = req.encryptionKey;
...
// Requires current password confirmation. Account is preserved.
...
// module.exports MUST remain at the end of the file so all routes above are registered.
