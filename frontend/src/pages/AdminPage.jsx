...
import { admin as adminApi, adminExt, smtpApi } from '../utils/api'
      ...
      <div className="admin-page">
        <div className="admin-header">
          <div>
            ...
            <p>Manage accounts, roles, and server settings</p>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: 0, borderBottom: '1px solid var(--border)', marginBottom: 24 }}>
          {[
            ...
            <button key={t.id} onClick={() => setAdminTab(t.id)} style={{
              ...
              fontFamily: 'var(--font)', fontSize: 13, fontWeight: adminTab === t.id ? 700 : 400,
              color: adminTab === t.id ? 'var(--coral)' : 'var(--text3)',
              borderBottom: '2px solid ' + (adminTab === t.id ? 'var(--coral)' : 'transparent'),
        ...
        {/* SMTP tab */}
        {adminTab === 'smtp' && <SmtpSettingsPanel />}
